...
<div class="container">
	<div class="col-md-12">
		<a href="#!" class="pull-right btn btn-danger">Bikin Produkmu Sekarang</a>
	</div>
</div>
	...
	<div class="container" style="margin-top: 80px">
		<div class="row">
			...
			<div class="col-md-3" style="margin-top: 40px">
				<img src="{{URL::to('1.jpg')}}" class="rounded-circle img-responsive" style="border: 2px solid #E5E5E5" width="100%">
			</div>
			<div class="col-md-3" style="margin-top: 40px">
				<img src="{{URL::to('1.jpg')}}" class="rounded-circle img-responsive" style="border: 2px solid #E5E5E5" width="100%">
			</div>
				...
				<div class="col-md-6 col-xs-12" style="margin-top: 40px">
					<ul class="ul-list">
						...
						<li>
							...
							Bantuan mendapatkan <b>LABEL HALAL</b> dari MUI
						</li>
						<li>
							<img src="{{URL::to('icon/png/4.png')}}" width="15%" style="float: left">
							<div style="padding-top: 10px">
								Bantuan mendapatkan <b>NOMOR IJIN EDAR</b> dari Dinas Kesehatan
							</div>
						</li>
					</ul>
				</div>
					...
					<ul class="ul-list">
						...
						<li>
							...
							<img src="{{URL::to('icon/png/7.png')}}" width="15%" style="float: left;">
								...
								(Kartu Nama, Banner, Brosur - Soft Copy)
							</div>
						</li>
					</ul>
				</div>
