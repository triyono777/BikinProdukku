		...
		<div class="box-body">
			<table class="table table-bordered table-hover table-striped">
				...
				<tr>
					...
					<td>:</td>
					<td>
						<input type="text" name="status_perkawinan" value="{{$dataDiri['status_perkawinan']}}" class="form-control">
					</td>
				</tr>
				<tr>
					<td>Pekerjaan</td>
				...
				<tr>
					...
					<td>:</td>
					<td>
						<img src="{{URL::to('upload/foto_pengguna/'.$dataDiri['foto'])}}" width="80" height="80" name="foto">
					</td>
				</tr>
				<tr>
